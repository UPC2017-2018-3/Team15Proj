        ...
        <table table align="center" style="background-color: #99ccff">
            <tr>
                <td colspan="2" style="height: 44px; text-align: center">
                    <strong><span style="font-size: 14pt; color: #ff3333; font-family: 仿宋_GB2312">添加新的课程记录</span></strong></td>
            </tr>
            <tr>
            ...
            <tr style="font-size: 12pt; color: #3300ff">
                <td style="width: 110px; text-align: right">
                    <span style="font-size: 10pt; color: #0000ff"><strong>课程名</strong></span></td>
            ...
            <tr style="font-size: 12pt; color: #0000ff">
                <td style="width: 110px; height: 22px; text-align: right">
                    <span style="font-size: 10pt;"><strong>上课学期</strong></span></td>
