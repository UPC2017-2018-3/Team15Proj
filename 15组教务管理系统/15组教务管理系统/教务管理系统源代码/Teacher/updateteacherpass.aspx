<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateteacherpass.aspx.cs" Inherits="updateteacherpass" StylesheetTheme="Blue" %>
<head runat="server">
    <title>无标题页</title>
    ...
    <div>
        <table align="center" style="background-color: #99ccff">
            ...
            <tr style="font-size: 12pt; color: #000000">
                <td style="width: 100px; text-align: right">
                    <span style="font-size: 10pt; color: #0000ff"><strong>重复一次</strong></span></td>
